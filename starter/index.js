...
// total change in Profit/Losses  from month to month (Month 2 – Month 1) 
...
var average = totalChange / (totalMonths - 1); //  find the average 

console.log( 'Average Change: ' + Math.round(average*100)/100); // and round to the nearest 100th
